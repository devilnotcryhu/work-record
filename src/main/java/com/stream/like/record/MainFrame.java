...
public class MainFrame extends Application {
    ...
    private double screenX_start;
    private double screenY_start;
    private double screenX_end;
    private double screenY_end;
    private double sceneX =100;
    private double sceneY =100;
    ...
    public void beginRecodeVideo(){
        ...
        primary.setIconified(true);
        //调用录屏API
        videoRecord = new VideoRecord(path, true,rectangle);
        videoRecord.start();
